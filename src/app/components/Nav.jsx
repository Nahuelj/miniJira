...
const Nav = () => {
  ...
  return (
    <div className="">
      <Sidebar  backgroundColor="#0E0E0E" className="text-white h-screen" style={{ left: 'auto', right: 0 }}>
        ...
        <Menu className="h-full   "   menuItemStyles={{
          ...
          <MenuItem className="pt-3 pb-3" icon={<NotificationIcons className=" text-3xl text-blue-600 w-9 " />}> Notificaciones </MenuItem>
          <MenuItem className="pt-3 pb-3" icon={<EquipoIcons className=" text-3xl text-blue-600 w-9 " />}> Equipo </MenuItem>
          <MenuItem className="pt-3 pb-3" icon={<SettingIcons className="font-light  text-3xl  w-9" />}> Configuraciones </MenuItem>

          <MenuItem className="pt-3 pb-3" active={true} icon={<HelpIcons className=" text-3xl text-blue-600 w-9"  />}>
            {" "}
            Ayuda{" "}
          </MenuItem>
